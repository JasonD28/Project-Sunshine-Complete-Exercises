...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadWeatherData() {
        ...
        new GithubAsync().execute(location);
    }
    ...
    public class GithubAsync extends AsyncTask<String, Void, String[]>{
        @Override
        protected String[] doInBackground(String... strings) {
            if(strings.length == 0){
                return null;
            }
            String locations = strings[0];
            URL weatherRequestUrl = NetworkUtils.buildUrl(locations);
