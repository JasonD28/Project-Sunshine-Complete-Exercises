...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFatalErrorMessage = (TextView) findViewById(R.id.tv_error_message_display);
    ...
    private void showJsonDataView(){
        mFatalErrorMessage.setVisibility(View.INVISIBLE);
    ...
    private void showErrorMessage(){
        mFatalErrorMessage.setVisibility(View.VISIBLE);
